  ...
  return (
    <section className="relative py-24 sm:py-32 md:py-40 lg:py-48 px-4 overflow-visible">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Hand with security image from right edge, vertically centered */}
        <div className="absolute top-1/2 -translate-y-1/2 -right-70 w-80 sm:w-96 md:w-[500px] lg:w-[600px] opacity-90 hover:opacity-100 transition-all duration-700 hover:-translate-x-4 hover:-translate-y-1/2 z-0">
